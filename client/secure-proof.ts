...
const nonceStore: Record<string, Record<string, number>> = {};

/**
 * Get and increment the nonce for the specified signer address and session
 */
export function getAndIncNonce(signerAddress: string, session: string): number {
 ...
 */
export async function generateDeProof(
  params: any,
  wallet: Wallet,
